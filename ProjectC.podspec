Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/tashyeghiazaryan/ProjectC.git"
  ...
  spec.source       = { :git => "https://github.com/tashyeghiazaryan/ProjectC.git", :tag => spec.version.to_s }
  ...
  spec.vendored_frameworks = "downloads/ProjectC.xcframework"
